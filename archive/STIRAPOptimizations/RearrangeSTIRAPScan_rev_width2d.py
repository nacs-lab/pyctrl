...
def build():
    ...
    g().AWG.AWG556.Ch2.pulse_width_us.scan(1, PW556_REV)   # SWEPT dim 1
    g().AWG.AWG556.Ch2.max_amplitude_vpp = 15   
    g().AWG.AWG556.Ch2.amplitude_scale = 0.51 
    ...
    g().AWG.AWG308.Ch2.pulse_width_us.scan(2, PW308_REV)   # SWEPT dim 2
    ...
    g().Pushout.STIRAPReverseDelay = -0.0556e-6 #-0.10e-6  
