...
def build():
    ...
    g().AWG.AWG556.Ch2.carrier_freq_MHz = 119.3573  # every_other REVERSE, MEASURED argmax (data_20260907_211247)
    ...
    g().Pushout.STIRAPReverseDelay = 0.153e-6  # measured argmax (data_20260907_213740, parabolic-refined)
    ...
    # ---- run params (runp) ---------------------------------------------------------------
    rp.NumPerGroup = 200  # = rep x n_points (100 x 2, forward+reverse verify)
