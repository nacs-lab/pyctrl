...
def build():
    ...
    g().rearrange_kwargs.extras.pattern = "eightfold_spacing"   # 2026-08-12: 8x ("octuple") spacing, 24 targets (job 923) #"quadruple_no_topright"  # 2026-07-10 quadruple_spacing (post optics move) -- the new default for the 33x33 array
