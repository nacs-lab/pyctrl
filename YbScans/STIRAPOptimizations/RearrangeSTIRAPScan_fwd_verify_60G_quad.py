...
def build():
    ...
    g().AWG.AWG556.Ch1.carrier_freq_MHz = 119.2466   # R8c along-ridge lock (parabolic-refined)
    ...
    g().Init.EOM616.Freq = 230.6808e6                # R8c along-ridge lock (parabolic-refined)
    ...
    g().rearrange_kwargs.extras.pattern = "quadruple_spacing"   # was double_spacing (R4-R6)
