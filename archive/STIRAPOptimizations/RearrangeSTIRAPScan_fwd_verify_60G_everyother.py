...
def build():
    ...
    g().AWG.AWG556.Ch1.carrier_freq_MHz = 118.3375   # every_other forward lock (08-27)
    ...
    g().AWG.AWG556.Ch2.carrier_freq_MHz = 118.5428  # every_other REVERSE lock (08-27, data_20260827_170604)
    ...
    g().Init.EOM616.Freq = 229.6655e6                # every_other forward lock (08-27)
