...
def build():
    ...
    g().AWG.AWG556.Ch1.carrier_freq_MHz = 118.1133   # quad_10x10 along-ridge lock (parabolic-refined)
    ...
    g().Init.EOM616.Freq = 228.7775e6                # quad_10x10 along-ridge lock (parabolic-refined)
    ...
    # ---- run params (runp) ---------------------------------------------------------------
    rp.NumPerGroup = 100  # = rep x n_points (100 x 1, R8e fixed-point verify)
