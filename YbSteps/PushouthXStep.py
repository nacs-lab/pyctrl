...
``g = s.C.Pushout``. Pushout pulse using the 369 fiber output: open the AbsImag and
369 shutters, set the 399 push-out beam (FreqAbsImag/AmpAbsImag) and the two 556 beams
