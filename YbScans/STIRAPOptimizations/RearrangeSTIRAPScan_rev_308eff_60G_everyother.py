...
def build():
    ...
    P308 = [0.3, 0.5, 0.7, 0.85, 1.0]
    g().AWG.AWG308.Ch1.amplitude_scale.scan(1, P308)
    g().AWG.AWG308.Ch2.amplitude_scale.scan(1, P308)   # SAME dim = co-varied, not a grid axis
    ...
    # ---- run params (runp) ---------------------------------------------------------------
    rp.NumPerGroup = 250  # = rep x n_points (25 x 10, 308-power x IfReverse)
