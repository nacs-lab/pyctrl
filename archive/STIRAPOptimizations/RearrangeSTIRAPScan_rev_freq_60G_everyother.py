...
def build():
    ...
    REV_CARRIER_MHZ = [round(float(v), 4) for v in np.linspace(119.1430 - 0.5, 119.1430 + 1.5, 29)]
    g().AWG.AWG556.Ch2.carrier_freq_MHz.scan(1, REV_CARRIER_MHZ)
    ...
    # ---- run params (runp) ---------------------------------------------------------------
    rp.NumPerGroup = 377  # = rep x n_points (13 x 29, reverse-frequency scan)
