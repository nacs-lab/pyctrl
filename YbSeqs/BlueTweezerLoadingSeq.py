"""BlueTweezerLoadingSeq.py -- transliteration of
``matlab_new/YbSeqs/BlueTweezerLoadingSeq.m``.

nargin-1 seq. Init -> BlueMOT -> SLM -> GreenMOT -> BlueLAC(LAC cfg) ->
Cool556hX(Cool556 cfg) -> Imag399 -> (wait) -> Init. Server callbacks are deferred
no-ops; fprintf logging dropped.
"""
